...
const UserProfileSkeleton = () => {
  return (
    <div className="pb-24">
      <div className="fixed top-0 right-0 left-0 z-40 mx-auto flex h-16 max-w-lg items-center justify-between border-b border-outline-variant/60 bg-background/95 px-4">
