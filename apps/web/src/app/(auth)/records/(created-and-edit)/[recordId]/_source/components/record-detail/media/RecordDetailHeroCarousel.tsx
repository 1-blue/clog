...
const RecordDetailHeroCarousel: React.FC<IProps> = ({
  ...
  if (imageUrls.length === 0) {
    return (
      ...
      >
        <div
          className="flex aspect-3/4 max-h-[min(100vh,28rem)] items-center justify-center md:aspect-video md:max-h-96"
          role="img"
  ...
  return (
    <>
      ...
      >
        ...
        >
          <div className="relative aspect-3/4 max-h-[min(100vh,28rem)] w-full md:aspect-video md:max-h-96">
            <img
              src={heroUrl}
              alt=""
              className="size-full object-cover transition-transform duration-300 ease-out group-active:scale-[0.99] group-hover:scale-[1.01]"
            />
