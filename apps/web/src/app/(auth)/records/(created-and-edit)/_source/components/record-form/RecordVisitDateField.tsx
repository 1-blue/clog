...
interface IProps {
  className?: string;
  /** 날짜 변경 직전(아직 dateYmd는 이전 값) — 초안 flush 등 */
  onBeforeDateYmdChange?: () => void;
}
...
const RecordVisitDateField = ({
  ...
  return (
    <div className={cn("flex flex-col gap-2", className)}>
      <span className={recordFormFieldLabelClass}>방문 날짜</span>
          ...
          <div className="flex justify-center pb-6">
            <Calendar
              ...
              classNames={{
                ...
                button_previous: visitCalendarNavButtonClass,
                button_next: visitCalendarNavButtonClass,
