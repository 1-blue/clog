...
import { prefetchGymsForRecordForm } from "#web/app/(auth)/records/(created-and-edit)/_source/utils/record-form-prefetch";
import { getQueryClient } from "#web/libs/getQueryClient";
import { getSharedMetadata } from "#web/libs/sharedMetadata";

import RecordNewMain from "./_components/record-new-main/RecordNewMain";
