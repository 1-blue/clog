...
import GymReviewMain from "./_components/gym-review/GymReviewMain";
import GymReviewSkeleton from "./_components/gym-review/skeleton/GymReviewSkeleton";
...
export const generateMetadata = async ({
  ...
  if (!payload) {
    return getSharedMetadata({ title: "리뷰 작성" });
  }
...
const GymReviewPage: NextPage<IProps> = async (props) => {
