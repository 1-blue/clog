/**
 * 클라이밍 세션 시작·종료 시각 UI/시드 공통 규칙 (같은 날 07:00 ~ 24:00, 5분 단위)
 * DB는 DateTime 그대로 저장하며, Prisma에는 도메인 규칙을 주석으로만 적어 둔다.
 */
export const SESSION_CLOCK_HOUR_MIN = 7;
export const SESSION_CLOCK_HOUR_MAX = 24;
...
/** 5분 단위 분 옵션 */
export const SESSION_MINUTE_OPTIONS = Array.from(
  { length: 12 },
  (_, i) => i * 5,
);
